...
public class ComboBoxFilterDecorator<T> {
                    ...
                    public void keyPressed(KeyEvent e) {
                        ...
                        switch (keyCode) {
                            ...
                            case KeyEvent.VK_ENTER:
                                selectedItem = comboBox.getSelectedItem();
                                System.out.println("sleted:"+selectedItem);
                                resetFilterComponent();
                                return;
    ...
    private void initComboPopupListener() {
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            {
            	System.out.println("popupMenuWillBecomeVisible : "+e.getSource().toString());
            }

            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {
            	System.out.println("popupMenuWillBecomeInvisible : "+e.getSource().toString());
            ...
            public void popupMenuCanceled(PopupMenuEvent e) {
            	System.out.println("popupMenuCanceled : "+e.getSource().toString());
